...
# it auto-starts infinity-launch.sh.
# ═════════════════════════════════════════════════════════════════
...
PROJECT_DIR="/home/kasperkal1970/infinity"
STATE_FILE="$PROJECT_DIR/.session_state.md"
LAUNCHER="$PROJECT_DIR/infinity-launch.sh"
...
if tmux has-session -t infinity 2>/dev/null; then
