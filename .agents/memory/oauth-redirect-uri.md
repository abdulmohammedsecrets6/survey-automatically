...
1. Set a stable `GOOGLE_REDIRECT_URI` environment variable (shared) pointing to the production URL or a fixed custom domain, e.g. `https://infinity--kasperkal.replit.app/api/infinity/gmail/callback`.
