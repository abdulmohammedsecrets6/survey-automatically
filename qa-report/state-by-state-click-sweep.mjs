...
const url = process.env.INFINITY_QA_URL || "http://localhost:21662/";
const outDir = process.env.INFINITY_QA_OUT || "./qa-report/state-clicks";
...
function hookPage(page, name) {
  ...
  page.on("request", (request) => {
    ...
    const blocked =
      requestUrl.includes("/api/infinity/chat") ||
      requestUrl.includes("/api/infinity/transcribe") ||
      requestUrl.includes("/api/infinity/speak") ||
      requestUrl.includes("/api/infinity/generate-image") ||
      requestUrl.includes("/api/infinity/verify") ||
      requestUrl.includes("/api/infinity/research") ||
      requestUrl.includes("/api/infinity/terminal") ||
      requestUrl.includes("/api/infinity/browse") ||
      requestUrl.includes("/api/infinity/gmail/auth") ||
      requestUrl.includes("/api/infinity/spotify/auth") ||
