      ...
      <div className="rounded-2xl border border-cyan-400/30 bg-cyan-500/5 overflow-hidden">
        <div className="flex items-center gap-2.5 px-4 pt-3.5 pb-2">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[11px] font-mono text-muted-foreground/60 truncate">
              Do you want to share your screen with Infinity AI?
            </p>
          </div>
        </div>
        <div className="flex items-center gap-2 px-4 pb-3.5">
...
/** "Use code for this answer?", Confirm allows Infinity AI to read his own source
...
/** "Open Infinity Build?", Confirm gives Infinity AI a Linux terminal + workspace to
      ...
      <div className="rounded-2xl border border-emerald-400/30 bg-emerald-500/5 overflow-hidden">
        <div className="flex items-center gap-2.5 px-4 pt-3.5 pb-2">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[11px] font-mono text-muted-foreground/60 truncate">
              Infinity AI gets a Linux terminal + workspace to set this up
            </p>
          </div>
        </div>
        <div className="px-4 pb-2">
