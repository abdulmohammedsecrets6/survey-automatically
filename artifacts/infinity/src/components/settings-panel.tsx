    ...
    const onMessage = (e: MessageEvent) => {
      if (e.data === 'gmail_connected') {
        ...
        toast({
          ...
          description: 'Infinity AI now has access to your inbox and calendar.',
              ...
              <AnimatePresence mode="wait">
                ...
                {view === 'personalization' && (
                  ...
                  >
                    ...
                    {/* Personality, how Infinity AI talks to you */}
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center pt-6 pb-4">
                      ...
                      <p className="mt-1 text-[13px] text-muted-foreground/70 text-center px-6">
                        Service credentials and LLM keys, stored in Infinity AI and applied instantly.
                      </p>
                    </div>
                ...
                {view === 'about' && (
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center pt-10 pb-4">
                      ...
                      <p className="text-[13px] text-muted-foreground/70 mt-1">Infinity AI AI · 2026</p>
                    </div>
                  </motion.div>
                )}
              </AnimatePresence>
