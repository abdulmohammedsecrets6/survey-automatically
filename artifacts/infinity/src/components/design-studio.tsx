...
export function DesignStudio({ open, onClose, initialImage }: DesignStudioProps) {
  ...
  const printPdf = () => {
    ...
    printWindow.document.write(`<html><head><title>Infinity AI design PDF</title><style>body{margin:0;display:grid;place-items:center;min-height:100vh}img{max-width:100%;max-height:100vh}</style></head><body><img src="${canvas.toDataURL('image/png')}" alt="Design" /></body></html>`);
