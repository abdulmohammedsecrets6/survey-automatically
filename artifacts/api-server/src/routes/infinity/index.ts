...
import projectChatbotRouter from "./project-chatbot";
import projectSharingRouter from "./project-sharing";
import projectExportRouter from "./project-export";
import projectFaqRouter from "./project-faq";
import projectConflictsRouter from "./project-conflicts";
import projectMindmapRouter from "./project-mindmap";
import projectCleanupRouter from "./project-cleanup";
import projectConnectorsRouter from "./project-connectors";
import projectAutomationsRouter from "./project-automations";
...
router.use(projectChatbotRouter);
router.use(projectFaqRouter);
router.use(projectConflictsRouter);
router.use(projectMindmapRouter);
router.use(projectCleanupRouter);
router.use(projectConnectorsRouter);
router.use(projectAutomationsRouter);
router.use(projectSharingRouter);
