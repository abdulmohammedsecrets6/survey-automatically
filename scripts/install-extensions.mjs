 ...
 * ~/.infinity-browser-extensions (auto-loaded on the next server start —
 * no env vars needed).
 *
 ...
 *   # or set INFINITY_BROWSER_EXTENSION_DIR to pick a different location
 *
...
const EXT_DIR = process.env.INFINITY_BROWSER_EXTENSION_DIR || join(homedir(), ".infinity-browser-extensions");
...
async function main() {
  ...
  console.log("restart (no env var needed). Override per-run with INFINITY_BROWSER_EXTENSIONS.");
  console.log("");
